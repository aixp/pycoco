	...
	def Test(self) -> None:
		if self.la.kind == self.__class__.ENUM.a_Sym:
			...
			if self.la.kind == self.__class__.ENUM.b_Sym:
				self.Get()
			self.Get()
		elif self.la.kind == self.__class__.ENUM.EOF_SYM or self.la.kind == self.__class__.ENUM.e_Sym:
			if self.la.kind == self.__class__.ENUM.e_Sym:
				self.Del()
		elif self.la.kind == self.__class__.ENUM.d_Sym:
			self.Get()
			if self.la.kind == self.__class__.ENUM.d_Sym or self.la.kind == self.__class__.ENUM.e_Sym or self.la.kind == self.__class__.ENUM.f_Sym:
